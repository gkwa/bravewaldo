...
import (
	...
	"github.com/gkwa/bravewaldo/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bravewaldo.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".bravewaldo")
	}
